...
plt.plot(data['taille'], data['hauteur_ABR'], label="hauteur ABR", color='green')
plt.xlabel("Taille (nombre de noeuds internes)")
...
plt.figure()
plt.plot(data['taille'], data['prof_moy_Remy'], label="profondeur moyenne Remy", color='orange')
plt.plot(data['taille'], data['hauteur_Remy'], label="hauteur Remy", color='green')
plt.xlabel("Taille (nombre de noeuds internes)")
